...
export const PodcastPlayer: React.FC<PodcastPlayerPropsType> = ({ podcast }) => {
      ...
      >
        ...
        {status?.isLoaded && (
          <View style={{ flexDirection: "row", gap: 10 }}>
            ...
            <AntDesign name="clockcircleo" size={24} color={Colors.universal.primary} />
          </View>
        )}
        ...
        {showInitialButton && (
          <View style={styles.initialButtons}>
            <Button
              ...
              disabled={isLoading}
            />
            <AntDesign name="download" size={24} color={Colors[colorScheme].defaultIcon} />
          </View>
        )}
      </View>
