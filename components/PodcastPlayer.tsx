...
// //   const isDownloadingPodcastStore = usePodcastDownloadStore((s) =>
// //     s.isDownloadingPodcastStore(podcast)
// //   );
// //   const setIsDownloadingPodcastStore = usePodcastDownloadStore(
// //     (s) => s.setIsDownloadingPodcastStore
// //   );
...
// //       setIsDownloadingPodcastStore(podcast, true)
...
// //       // Mark as manually loaded to prevent effect from double-loading
...
// //       setIsDownloadingPodcastStore(podcast, false)
...
// //     // If we were streaming and cancelled download, restore stream state
...
// //           {/* Download Progress */}
// //           {(showDownloadProgress  || isDownloadingPodcastStore) && (
...
// //           {showInitialButtons && !isDownloadingPodcastStore && (
