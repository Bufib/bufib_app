    ...
    >
      ...
      <View style={styles.aboutContainer}>
        <ThemedText style={styles.aboutText}>
          ...
          Bedarf nach der Beantwortung von Glaubens- und Rechtsfragen nachkommen
          zu können und in Zukunft Antworten auf die häufig gestellten Fragen
          bereitzustellen.
          {"\n"}
          {"\n"}
          Die Beantwortung der Rechtsfragen erfolgt in erster Linie gemäß der
          Rechtsprechung der beiden Großgelehrten Sayid Ali al-Khamenei (h.) und
          Sayid Ali as-Sistani (h.), da sie im deutschsprachigen Raum die
